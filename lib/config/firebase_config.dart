...
class FirebaseConfig{
  ...
  final String authDomain = 'bloc-boiler-plate.firebaseapp.com';
  final String databaseURL = 'https://bloc-boiler-plate.firebaseio.com';
  final String projectId = 'bloc-boiler-plate';
  final String storageBucket = 'bloc-boiler-plate.appspot.com';
